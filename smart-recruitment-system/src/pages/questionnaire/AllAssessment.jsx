...
const AllAssessment = () => {
    ...
    const fetchData = async () => {
        ...
        try {
          ...
          const [resultResponse, countResponse, titleResponse] = await Promise.all([
            axios.post(`${BASE_URL}Assessment/get-assessment-summery`, requestBody, {
              headers: {
            ...
            axios.post(`${BASE_URL}Assessment/get-assessment-summery-count`, requestBody, {
              headers: {
                Authorization: `Bearer ${authToken}`,
                userId,
                organizationId,
    ...
    return(
      ...
      <div className="flex items-center justify-between px-[85px] mt-6 mb-4">
